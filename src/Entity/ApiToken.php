...
class ApiToken
{
    ...
    public const SCOPE_PRODUCT_CREATE = 'ROLE_PRODUCT_CREATE';
    public const SCOPE_PRODUCT_EDIT = 'ROLE_PRODUCT_EDIT';

    public const SCOPES = [
        self::SCOPE_USER_EDIT => 'Edit User',
        self::SCOPE_PRODUCT_CREATE => 'Create Product',
        self::SCOPE_PRODUCT_EDIT => 'Edit Product',
    ];
